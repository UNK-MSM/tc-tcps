...
class StockClosingReadingForResult extends BaseModel
{
    //
    protected $table = "stock_closing_readings";


    protected $hidden = [
            'direction',
            'greatest_probability',
            'greatest_probability_direction',
    ...
    protected $appends = [
            ...
            'predicted_general_direction',
        ];
    protected $dates = ['date_closed'];

    public function stock()
    {
        return $this->belongsTo('\App\Stock', 'stock_serial_no');
    }
    ...
    public function getPredictedGeneralDirectionAttribute()
    {
        $direction = 'ارتفاع';
        $rate = $this->predicted_rising_selling_closing_price_rate;
        if($this->predicted_stable_selling_closing_price_rate > $rate)
    ...
    {
        $value = $this->predicted_general_selling_closing_price;
        /*$value = $this->predicted_falling_selling_closing_price;
