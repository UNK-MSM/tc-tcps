...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item">
                            <a href="{{route('membership_type.index')}}" class="nav-link nav-toggle">
                                <i class="icon-folder"></i>
                                <span class="title">{{trans('sidebar.membership_type')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item active open">
                            <a href="{{route('membership.index')}}" class="nav-link nav-toggle">
                                <i class="icon-credit-card"></i>
                                <span class="title">{{trans('sidebar.membership')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('membership_custom_plan.index')}}" class="nav-link nav-toggle">
                                <i class="icon-badge"></i>
                                <span class="title">{{trans('sidebar.membership_custom_plan')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('stock_entry_source.index')}}" class="nav-link nav-toggle">
                                <i class="icon-share"></i>
                                <span class="title">{{trans('sidebar.stock_entry_source')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('stock_market_vacation.index')}}" class="nav-link nav-toggle">
                                <i class="icon-calendar"></i>
                                <span class="title">{{trans('sidebar.stock_market_vacation')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('membership_plan.index')}}" class="nav-link nav-toggle">
                                <i class="icon-badge"></i>
                                <span class="title">{{trans('sidebar.membership_plan')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('urgent_cause.index')}}" class="nav-link nav-toggle">
                                <i class="icon-flag"></i>
                                <span class="title">{{trans('sidebar.urgent_cause')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('stock_market.index')}}" class="nav-link nav-toggle">
                                <i class="icon-graph"></i>
                                <span class="title">{{trans('sidebar.stock_market')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('stock_type.index')}}" class="nav-link nav-toggle">
                                <i class="icon-graph"></i>
                                <span class="title">{{trans('sidebar.stock_type')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('stock.create')}}" class="nav-link nav-toggle">
                                <i class="icon-graph"></i>
                                <span class="title">{{trans('sidebar.stock')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('user_type.index')}}" class="nav-link nav-toggle">
                                <i class="icon-users"></i>
                                <span class="title">{{trans('sidebar.user_type')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('user_status.index')}}" class="nav-link nav-toggle">
                                <i class="icon-tag"></i>
                                <span class="title">{{trans('sidebar.user_status')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('prediction_status.index')}}" class="nav-link nav-toggle">
                                <i class="icon-question"></i>
                                <span class="title">{{trans('sidebar.prediction_status')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('country.index')}}" class="nav-link nav-toggle">
                                ...
                                <span class="title">{{trans('sidebar.country')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('user.index')}}" class="nav-link nav-toggle">
                                <i class="icon-users"></i>
                                <span class="title">{{trans('sidebar.user')}}</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; TrendCast.
            </div>
...
<![endif]-->
        ...
        <script src="{{asset('assets/global/scripts/app_custom.js')}}" type="text/javascript"></script>
